...
import loader from "../../assets/images/ailoader.gif";
  ...
  const AccessDenied = (props: PropData) => {
      return (
          <div className="no-data-available-box">
              {
                  !props.isShowLoader && props.isShowMessage && <div className="noDataMessage">
                      <div className="center-data">
                          ...
                          <div className='text-secondary '><h3 className='font-16'>{props.message?props.message:"You Don't Have Access Of this page"}</h3></div>
                      </div>
                  </div >
              }
              {
